  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center p-2 px-3 shadow-md bg-gray-100">
      <div className="contents">
        <span
          className="text-xl cursor-pointer p-2 hover:text-purple-500"
          onClick={() => navigate("/home")}
        >
          <img src="https://bbijtm.bpitindia.ac.in/images/logo-websitebg.png" />
        </span>
      </div>
      <div className="flex gap-4 pr-4">
        ...
        {boardVisible && (
          <div className="absolute bg-white ml-[5%] mt-[4%] p-2 rounded-md shadow-md flex flex-col">
            <span
              className="text-xl cursor-pointer p-2 hover:text-purple-500"
